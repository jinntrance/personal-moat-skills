...
description: 读书笔记整理工具。当用户提供读书笔记、摘录、书评或阅读感悟时，自动生成：(1) Mermaid 格式脑图、(2) Markdown 层级大纲脑图、(3) 关键笔记摘要。触发条件：用户说"整理我的读书笔记"、"帮我做脑图"、"生成思维导图"、"reading notes"、"笔记整理"、"把笔记变成脑图"，或者粘贴了一段读书笔记并希望可视化整理。务必在用户提供任何读书笔记或想整理笔记时主动使用此技能。
---
